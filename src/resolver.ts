...
export class Resolver {
    ...
    #cachedPackageJson: Record<string, PackageJson | undefined>;
    ...
    constructor(ts: typeof typescript, compilerOptions: typescript.CompilerOptions, alias?: Record<string, string>) {
        ...
        this.#matchers = [
            (moduleName: string, sourceFileName: string) => {
        ...
        if (alias) {
            ...
            this.#matchers.push(
                ...Object.entries(alias).map(([from, to]) => {
                    ...
                    return function (moduleName: string, sourceFileName: string) {
    ...
    resolve(moduleName: string, sourceFileName: string) {
    ...
    private resolveModule(sourceFilePath: string, moduleName: string) {
        ...
        if (this.#compilerOptions.rootDirs) {
            ...
            let moduleRootDir: string | undefined;
    ...
    private findNearestPackageJson(srcDir: string): PackageJson {
        ...
        return <PackageJson>this.#cachedPackageJson[srcDir];
    }
}
